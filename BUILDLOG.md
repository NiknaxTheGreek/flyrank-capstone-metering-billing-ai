...
- Verified Checkout completion resolves tenant identity exclusively from Stripe Checkout metadata/client-reference information. It records Stripe customer/subscription identifiers and upgrades the referenced local subscription from Free to Pro only within the verified event transaction.
